...
const InfoModal = ({ onClose }: ICModalProps) => {
	return (
		<Modal title="About CapScreen" isOpen={true} onClose={onClose} Footer={<Footer />}>
			<div className={style.infoModal}>
				...
				<div className={style.infoModalContent}>
					<p className={style.infoModalContentText}>
						<b>CapScreen</b> is a free screen-recording application for Windows, macOS, and
					...
					>
						<b>Found a bug?</b>{' '}
						<a
							href="https://videocloud.cf/contact"
							target="_blank"
							rel="noreferrer"
					...
					<ul className={style.infoModalContentList}>
						<li>
							...
							traffic lights and the CapScreen at the center.
						</li>
						<li>
					...
					<ul className={style.infoModalContentList}>
						<li>
							...
							for CapScreen? Now you have a wide variety of formats to choose from, you
						...
						<li>
							<b>New face.</b> Now CapScreen has its own face! A brand new unique logo
							should fit well!
						</li>
						<li>
